...
{
    KeyboardBG  KeyboardBG::BottomBox = KeyboardBG(0, 0, 320, 240, true, nullptr);


    KeyboardBG::KeyboardBG(u32 posX, u32 posY, u32 width, u32 height, bool closeBtn, BMPImage* image) :
        _rect2(posX, posY, width, height),
        _border2(posX + 2, posY + 2, width - 4, height - 4),
        _image2(image)

    {
        BottomBox._image2 = Preferences::bottomBoxBGImage;
