...
namespace CTRPluginFramework
{
    ...
    {
        path = "/Tricord/Resources/Documents/";
        u32                         pos = path.rfind("/");
    ...
    _isOpen(false), _menu(CreateFolder("Documents"), Icon::DrawFile), _guideTB("", "", Window::TopWindow.GetRect()), _text(""), _last(nullptr)
    //_closeBtn(*this, nullptr, IntRect(275, 24, 20, 20), Icon::DrawClose)
    {
        _isOpen = false;
        _image = nullptr;
        if (Directory::Open(_currentDirectory, "Documents") == 0)
        {
