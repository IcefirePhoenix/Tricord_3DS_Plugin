...
namespace CTRPluginFramework
{
    void hideHUD(MenuEntry* entry) {
        ...
        if (pointerCheck != 0x00000000) {
            Process::Write32((AddressList::HUDPointer.addr + mainHUDoffset), 0x7F000004);
            Process::Write32((AddressList::HUDPointer.addr + ActionButtonBGOffset), 0x00000010);
            Process::Write32((AddressList::HUDPointer.addr + ActionBUttonTextOffset), 0x00FFFF00);
        }
    }
