...
namespace CTRPluginFramework
{
    ...
    void    InitMenu(PluginMenu& menu)
    {
        ...
        {
            *costume += new MenuEntry("Use Custom Costume Slots", openCustomCostumeSlots);
            *costume += new MenuEntry("Enable 1st slot", customCostumeSlotA);
            *costume += new MenuEntry("Enable 2nd slot", customCostumeSlotB);
            *costume += new MenuEntry("Enable 3rd slot", customCostumeSlotC);
            *costume += new MenuEntry("Enable 4th slot", customCostumeSlotD);
            *costume += new MenuEntry("Restore Great Fairy Costume", greatFairyEnable);
        }
        ...
        *costume += new MenuEntry("Change Green Link Costume", nullptr, gChangeCostume);
        *costume += new MenuEntry("Change Blue Link Costume", nullptr, bChangeCostume);
        *costume += new MenuEntry("Change Red Link Costume", nullptr, rChangeCostume);
