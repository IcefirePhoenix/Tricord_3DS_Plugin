...
namespace CTRPluginFramework {
	...
	void AddressList::InitAddresses(void) {
		/* Camera */ 
		DynamicCameraCheck 			= Address(0x00143810, 0x0014382C, 0x00000000, 0x00000000);
		GameplayCameraCheck 		= Address(0x00143A7C, 0x00143A98, 0x00000000, 0x00000000);
		GameplayCameraInit 			= Address(0x00143A80, 0x00143A9C, 0x00000000, 0x00000000);
		RetGameplayCameraInit 		= Address(0x00143B80, 0x00143B9C, 0x00000000, 0x00000000);
		...
		PerspectiveZoom 			= Address(0x005F529C, 0x005F56CC, 0x00000000, 0x00000000);

		/* Chaos */ 
		HeartsTakeHealth 			= Address(0x0015CA04, 0x0015CA20, 0x00000000, 0x00000000);

		/* Costume */ 
		CostumeAttrA 				= Address(0x32849510, 0x32849590, 0x00000000, 0x00000000);
		CostumeAttrB 				= Address(0x32849512, 0x32849592, 0x00000000, 0x00000000);
		CostumeAttrC 				= Address(0x32849513, 0x32849593, 0x00000000, 0x00000000);
		CostumeAttrD				= Address(0x32849514, 0x32849594, 0x00000000, 0x00000000);
		...
		CurrSpawnID 				= Address(0x3280EDCA, 0x3280EE4A, 0x00000000, 0x00000000);
		...
		EnemyDataPointer			= Address(0x32989188, 0x32989208, 0x00000000, 0x00000000);
		...
		EnergyCurrent				= Address(0x328496C4, 0x32849744, 0x00000000, 0x00000000);
		EnergyMax					= Address(0x00192644, 0x001926D4, 0x00000000, 0x00000000);
		EnergyMaxPitRecovery		= Address(0x001925F8, 0x00192588, 0x00000000, 0x00000000);
		EnergyMaxMultiplicand		= Address(0x00192684, 0x00192714, 0x00000000, 0x00000000);
		FairiesCurrent				= Address(0x32D81F14, 0x32D81F94, 0x00000000, 0x00000000);
		TimeLeft					= Address(0x32D81F18, 0x32D81F98, 0x00000000, 0x00000000);
		CollisionCurrent			= Address(0x328416A4, 0x32841724, 0x00000000, 0x00000000);
		SpeedX						= Address(0x32841650, 0x328416D0, 0x00000000, 0x00000000);
		SpeedY						= Address(0x32841654, 0x328416D4, 0x00000000, 0x00000000);
		SpeedZ						= Address(0x32841658, 0x328416D8, 0x00000000, 0x00000000);
		TotemCarrying				= Address(0x32849520, 0x328495A0, 0x00000000, 0x00000000);
		TotemCarriedBy				= Address(0x32849524, 0x328495A4, 0x00000000, 0x00000000);
		LoadingStatus 				= Address(0x319FE1D0, 0x319FE228, 0x00000000, 0x00000000);
		...
		RoboNiceAtk 				= Address(0x00156AB4, 0x00156AD0, 0x00000000, 0x00000000);
		RoboNiceSFX 				= Address(0x003C2030, 0x003C23D8, 0x00000000, 0x00000000);
		RoboNiceSpeed 				= Address(0x00156898, 0x001568B4, 0x00000000, 0x00000000);
		...
		CheckPhotoExist 			= Address(0x31B2FE3D, 0x31B2FEBD, 0x00000000, 0x00000000);
		...
		/* Rendering */ 
		ArrowIndicatorColorBot 		= Address(0x32D91B24, 0x32D91BA4, 0x00000000, 0x00000000);
		ArrowIndicatorColorMid 		= Address(0x32D91A04, 0x32D91A84, 0x00000000, 0x00000000);
		ArrowIndicatorColorTop 		= Address(0x32D918E4, 0x32D91964, 0x00000000, 0x00000000);
		HUDPointer 					= Address(0x32C8289C, 0x32C8291C, 0x00000000, 0x00000000);
		FogA 						= Address(0x31B31BE4, 0x31B31C64, 0x00000000, 0x00000000);
		FogB 						= Address(0x31B31BDC, 0x31B31C5C, 0x00000000, 0x00000000);
		FogC 						= Address(0x31B31BE0, 0x31B31C60, 0x00000000, 0x00000000);
		ScrollingTextOpacity 		= Address(0x00151C40, 0x00151C5C, 0x00000000, 0x00000000);
		OffScreenLocation 			= Address(0x32D83094, 0x32D83114, 0x00000000, 0x00000000);
		TextureName					= Address(0x3033D7C3, 0x30363E43, 0x00000000, 0x00000000);
		LoadingScreenSPNoChal		= Address(0x002B1410, 0x002B17B4, 0x00000000, 0x00000000);
		LoadingScreenSPIcons		= Address(0x00390C08, 0x00390FB0, 0x00000000, 0x00000000);

		/* Savefile */ 
		NormalNCCompletion 			= Address(0x31A060EC, 0x31A06144, 0x00000000, 0x00000000);
		NormalC1Completion 			= Address(0x31A060F4, 0x31A0614C, 0x00000000, 0x00000000);
		NormalC2Completion 			= Address(0x31A060FC, 0x31A06154, 0x00000000, 0x00000000);
		NormalC3Completion 			= Address(0x31A06104, 0x31A0615C, 0x00000000, 0x00000000);
		SoloNCCompletion 			= Address(0x31A0616C, 0x31A061C4, 0x00000000, 0x00000000);
		SoloC1Completion 			= Address(0x31A06174, 0x31A061CC, 0x00000000, 0x00000000);
		SoloC2Completion 			= Address(0x31A0617C, 0x31A061D4, 0x00000000, 0x00000000);
		SoloC3Completion 			= Address(0x31A06184, 0x31A061DC, 0x00000000, 0x00000000);
		MultiNCCompletion 			= Address(0x31A0612C, 0x31A06184, 0x00000000, 0x00000000);
		MultiC1Completion 			= Address(0x31A06134, 0x31A0618C, 0x00000000, 0x00000000);
		MultiC2Completion 			= Address(0x31A0613C, 0x31A06194, 0x00000000, 0x00000000);
		MultiC3Completion 			= Address(0x31A06144, 0x31A0619C, 0x00000000, 0x00000000);

		CostumeObtainStatus 		= Address(0x32C8256A, 0x32C825EA, 0x00000000, 0x00000000);
		ColiseumWinCount 			= Address(0x31A062AC, 0x31A06304, 0x00000000, 0x00000000);
		EditMerchantStock 			= Address(0x31A077A4, 0x31A077FC, 0x00000000, 0x00000000);
		HeroPointCount 				= Address(0x31A0611C, 0x31A06174, 0x00000000, 0x00000000);
		MainVoice 					= Address(0x31A06118, 0x31A06170, 0x00000000, 0x00000000);
		ResetMerchantStock 			= Address(0x31A077AE, 0x31A07806, 0x00000000, 0x00000000);

		// SFX and BGM
		BGMType 					= Address(0x005FD3C0, 0x005FD7F0, 0x00000000, 0x00000000);
		BGMVolume 					= Address(0x00236444, 0x002364D4, 0x00000000, 0x00000000);
		LobbyBallPointer			= Address(0x32DCAA60, 0x32DCAAE0, 0x00000000, 0x00000000);
		LinkVoiceSpeed 				= Address(0x3284A25C, 0x3284A2DC, 0x00000000, 0x00000000);
		MasterVolume 				= Address(0x0050BC74, 0x0050BDF0, 0x00000000, 0x00000000);
	}
